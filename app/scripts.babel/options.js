...
app.controller('ShortkeysOptionsCtrl', ['$scope', function($scope) {
    ...
    $scope.actionOptions = [
        ...
        {value:'openbookmark', label: 'Open Bookmark/Bookmarklet in current tab', group: 'Location'},
        {value:'openbookmarknewtab', label: 'Open Bookmark/Bookmarklet in new tab', group: 'Location'},
