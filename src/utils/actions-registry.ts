...
export const ACTION_CATEGORIES: Record<string, ActionDefinition[]> = {
  ...
  Location: [
    ...
    { value: 'copypagetitle', label: 'Copy page title' },
    { value: 'copytitleurl', label: 'Copy title and URL' },
    { value: 'copytitleurlmarkdown', label: 'Copy as markdown link [title](url)' },
    { value: 'openclipboardurl', label: 'Open URL from clipboard' },
    { value: 'openclipboardurlnewtab', label: 'Open URL from clipboard in new tab' },
  ...
  Tabs: [
    ...
    { value: 'closeduplicatetabs', label: 'Close duplicate tabs' },
    ...
    { value: 'sorttabs', label: 'Sort tabs alphabetically by title' },
    { value: 'discardtab', label: 'Suspend tab (free memory)' },
  ],
  Windows: [
  ...
  Miscellaneous: [
    ...
    { value: 'togglebookmark', label: 'Bookmark/unbookmark current page' },
    { value: 'openincognito', label: 'Open current page in incognito window' },
