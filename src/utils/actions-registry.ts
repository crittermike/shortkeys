...
export const ACTION_CATEGORIES: Record<string, ActionDefinition[]> = {
  ...
  Tabs: [
    ...
    { value: 'grouptab', label: 'Group tab', description: 'Add selected tabs (or current tab) to a new tab group' },
    ...
    { value: 'collapsegroup', label: 'Collapse tab group', description: 'Collapse the current tab\'s group to hide its tabs' },
    { value: 'expandgroup', label: 'Expand tab group', description: 'Expand the current tab\'s group to show its tabs' },
    { value: 'togglecollapsegroup', label: 'Toggle collapse group', description: 'Toggle collapse/expand of the current tab\'s group' },
